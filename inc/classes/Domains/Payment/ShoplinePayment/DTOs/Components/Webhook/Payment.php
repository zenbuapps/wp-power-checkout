...
final class Payment extends DTO {
	...
	/** @var string Enums\PaymentMethod::value *付款方式 (16) */
	...
	/** @var string Enums\PaymentBehavior::value *付款場景 (32) 必填參考 */
	...
	/** @var string|null SHOPLINE Payments 付款會員 ID，快捷付款、定期扣款場景必填 (32) 選填 */
